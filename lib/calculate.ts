...
export function calculateQuote(
  ...
  const definitions: Array<[keyof typeof costs, string, boolean, string?]> = [
    ...
    ["backup", "Backup", true],
    ["accessories", "Accessories (cables, bracket, etc.)", false, `$${settings.accessoryCostPerKw.toFixed(0)} × PV system size`],
    ["solarInstallation", "Solar Installation", false, `$${settings.solarInstallCostPerWatt.toFixed(2)} × PV system size × 1000`],
